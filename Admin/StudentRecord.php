...
<?php 
	...
	$start = ($page - 1) * $limit;
	$result = $conn->query("SELECT * FROM studentinformation LIMIT $start, $limit");
	$students = $result->fetch_all(MYSQLI_ASSOC);

	$result1 = $conn->query("SELECT count(StudentName) AS StudentName FROM studentinformation");
	$studCount = $result1->fetch_all(MYSQLI_ASSOC);
	$total = $studCount[0]['StudentName'];
                    ...
                    <table id="" class="table table-striped table-bordered">
                        ...
                        <tbody id="queryTable">
                            ...
                            <tr>
                                ...
                                <td><?= $student['StatusOfAccount']; ?></td>
                                <td><?= $student['CoursName']; ?></td>
                                <td><a href="StudentRecord.php?getinfo=<?= $student ['StudentID']; ?>"><button class="view">View</button></a></td>
                                <td><a href="StudentRecord.php?deletedata=<?= $student ['StudentID']; ?>"><button class="dlt">Delete</button></a></td>
                            </tr>
                            <?php endforeach; 
                            ...
                            $sql = "DELETE FROM studentinformation WHERE StudentID = $name;";
                        ...
                        <div class="transparent">
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li><a href="StudentRecord.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                                    <?php endfor; ?>
                                    <li>
                                        <a href="StudentRecord.php?page=<?= $Next; ?>" aria-label="Next">
